...
__int64 __fastcall sub_40D817(char *a1, _DWORD *a2, __int64 (__fastcall *a3)(char *, char *, __int64), __int64 a4, unsigned int a5, void (__fastcall *a6)(char *, __int64), int a7, int a8, int a9, bool a10)
{
  int v10; // eax
  bool v12; // al
  int v13; // eax
