...
__int64 __fastcall sub_40711C(char *a1, void *a2, _QWORD *a3)
{
  void *v3; // rsp
  ...
  while ( 1 )
  {
    sub_406CF2((__int64)v34);
    if ( v39 == 1 && !v40 )
      break;
    sub_406C1B(48 * v17 + v24, (__int64)&s2);
    s2 = (char *)s2 + v38;
    v36 = 0;
    ++v17;
  }
