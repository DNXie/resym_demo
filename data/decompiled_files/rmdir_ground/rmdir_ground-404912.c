...
void *__fastcall sub_404912(void *a1, unsigned __int64 *a2, void *a3, __int64 a4, double a5, double a6, double a7, double a8, double a9, double a10, double a11, double a12)
{
  int v13; // esi
  int v14; // edi
  int v15; // ecx
  ...
  if ( (int)sub_408A37(a3, &v197, v194) < 0 )
    return 0LL;
  if ( (int)sub_408125(v108, v194) < 0 )
  {
    if ( ptr != v201 )
      free(ptr);
    if ( v195 != v196 )
  ...
  v13 = v199;
  v14 = 7;
  v164 = sub_404836(7uLL, v199, v200, 6LL);
  if ( v164 > 0xF9F )
  {
    size = v164;
    if ( v164 == -1LL )
  ...
  for ( i = (char *)ptr; ; i += 88 )
  {
    ...
    if ( v197 == v139 )
    {
      ...
      if ( v22 > v142 )
      {
        ...
        v142 = v104;
        v105 = sub_404802(n, 1LL);
        if ( v105 > v142 )
          v142 = sub_404802(n, 1LL);
        v169 = v142;
        if ( v142 == -1LL )
          goto LABEL_525;
    ...
    *(_QWORD *)&v106 = *((_QWORD *)v25 + 2);
    ...
    if ( !sub_4048CD(v14, v13, a5, a6, a7, a8, v18, v19, a11, a12, DWORD2(v106), v15, v16, v17, v106) )
      break;
    v114 = *((_DWORD *)i + 4);
    v115 = 0;
    v146 = 0LL;
    ...
    if ( v147 )
      v148 = v147;
    v148 = sub_404802(v148, 12LL);
    if ( v148 < v146 )
      v148 = v146;
    v32 = v148;
    v148 = sub_404802(v148, 1LL);
    if ( v148 > 0x2BC )
    {
      v173 = v148;
      if ( v148 == -1LL )
    ...
    *(_QWORD *)&v191 = *((_QWORD *)v36 + 2);
    DWORD2(v191) = v37;
    if ( (unsigned int)sub_4080CD(v32, 1, v37, v33, v34, v35, *(__int64 *)&v191, v37) )
    {
      if ( i[72] <= 64 || i[72] > 90 )
      {
        v41 = v151++;
...
LABEL_260:
  ...
  *(_WORD *)v159 = (unsigned __int8)i[72];
  ...
  if ( v94 > v142 )
  {
    ...
    v142 = v95;
    v96 = sub_404802(n, 2LL);
    if ( v96 > v142 )
      v142 = sub_404802(n, 2LL);
    v180 = v142;
    if ( v142 != -1LL )
    {
...
LABEL_443:
    ...
    if ( (v142 & 0x8000000000000000LL) != 0LL )
      ...
      v101 = 2 * v142;
    v102 = sub_404802(n, (unsigned int)(v113 + 2));
    v189 = sub_404881(v102, v101);
    if ( v189 > v142 )
    {
      if ( v142 )
      {
