...
unsigned __int64 __fastcall sub_402969(__int64 a1, unsigned __int64 a2, __int64 a3, size_t a4, unsigned int a5, int a6, __int64 a7, char *a8, char *a9)
{
  int v9; // eax
  bool v10; // al
  int v11; // eax
  ...
  if ( a5 > 3 )
  {
    ...
    if ( a5 >= 5 )
    {
      ...
      if ( a5 != 8 )
      {
        a8 = sub_40292C((const char *)L"`'", a5);
        a9 = sub_40292C((const char *)L"'", a5);
      }
      if ( (a6 & 2) == 0 )
      {
        for ( s = a8; *s; ++s )
...
LABEL_33:
  for ( i = 0LL; a4 == -1LL ? *(_BYTE *)(a3 + i) != 0 : i != a4; ++i )
  {
    ...
    {
      if ( v21 )
        return sub_402969(a1, a2, a3, a4, a5, a6 & 0xFFFFFFFD, 0LL, (__int64)a8, (__int64)a9);
      v24 = 1;
    }
    v22 = *(_BYTE *)(a3 + i);
    if ( v22 > 0x3Au )
