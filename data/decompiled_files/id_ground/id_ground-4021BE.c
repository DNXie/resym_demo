...
__int64 __fastcall sub_4021BE(__int64 a1, __uid_t a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  unsigned int v5; // eax
  __int64 v6; // r12
  char *v7; // rbx
  ...
  if ( !v19 )
    v15 = 0;
  if ( (unsigned __int8)sub_402379(a3, a5) != 1 )
    v15 = 0;
  if ( a4 != a3 )
  {
    putchar_unlocked(32);
    if ( (unsigned __int8)sub_402379(a4, a5) != 1 )
      v15 = 0;
  }
  if ( v19 )
    v5 = v19->pw_gid;
  ...
  if ( v17 >= 0 )
  {
    for ( i = 0; i < v17; ++i )
    {
      ...
      {
        putchar_unlocked(32);
        if ( (unsigned __int8)sub_402379(*((unsigned int *)ptr + i), a5) != 1 )
          v15 = 0;
      }
    }
    free(ptr);
