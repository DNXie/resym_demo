...
char *__fastcall sub_40B4DA(char *a1, size_t a2)
{
  char *v3; // rbx
  char v4; // al
  size_t v5; // rax
  ...
  *v3 = 0;
  ...
  while ( 2 )
  {
    if ( v14 != v21 || v15 != v22 )
    {
      ...
      {
        v8 = 1;
        if ( !(unsigned int)sub_40BE70(fd, &stat_buf) )
        {
              ...
              while ( 1 )
              {
                *__errno_location() = 0;
                ...
                if ( v20->d_name[0] != 46 || v20->d_name[1] && (v20->d_name[1] != 46 || v20->d_name[2]) )
                {
                  ...
                  {
                    if ( !(unsigned int)sub_40BE90(fd, v20->d_name, &stat_buf, 256)
