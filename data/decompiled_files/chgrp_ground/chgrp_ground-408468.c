...
__int64 __fastcall sub_408468(__int64 a1, __int64 a2, char a3)
{
  __int64 result; // rax
  __int64 v4; // rax
  ...
  {
    if ( (unsigned int)sub_40B2D0(*(char **)(a2 + 48), s) )
    {
      v6 = *__errno_location();
      if ( *__errno_location() == 2 && !(unsigned int)sub_40B2F0(*(char **)(a2 + 48), s) )
      {
        *__errno_location() = 0;
        return 13LL;
      }
  ...
  else if ( (unsigned int)sub_40B300(*(_DWORD *)(a1 + 44), *(char **)(a2 + 48), s, 256) )
  {
