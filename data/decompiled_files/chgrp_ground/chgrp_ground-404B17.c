...
void *__fastcall sub_404B17(int a1, __int64 a2, size_t a3, __int64 a4)
{
  __int64 *v4; // rax
  void *v5; // rdx
  ...
  if ( dword_60F260 <= (unsigned int)a1 )
  {
    ...
    if ( off_60F280 == &qword_60F270 )
      ...
      v4 = off_60F280;
    v12 = (__int64 *)sub_405B16(v4, 16 * v14);
    off_60F280 = v12;
    if ( v9 )
    {
      v5 = off_60F278;
  ...
  ptr = (void *)v12[2 * a1 + 1];
  v11 = *(_DWORD *)(a4 + 4) | 1;
  v17 = sub_403C23((__int64)ptr, v15, a2, a3, *(_DWORD *)a4, v11, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  if ( v15 <= v17 )
  {
    v16 = v17 + 1;
    v12[2 * a1] = v17 + 1;
    if ( ptr != &unk_60F380 )
      free(ptr);
    ptr = (void *)sub_405AC7(v16);
    v12[2 * a1 + 1] = (__int64)ptr;
    sub_403C23((__int64)ptr, v16, a2, a3, *(_DWORD *)a4, v11, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  }
