...
void *__fastcall sub_407A26(__int64 a1, int a2, __int64 a3, __int64 a4, int a5, int a6)
{
  void *result; // rax
  int v8; // edx
  int v9; // eax
...
LABEL_28:
    ...
    else if ( v42 || a2 == 3 )
    {
      ...
      {
        fd = sub_40AD17((unsigned int)fd);
        if ( fd >= 0 )
          sub_408EA0((unsigned int)fd, 1LL);
      }
      if ( fd < 0 || (unsigned int)sub_408AD0(a1, v45, (unsigned int)fd, 0LL) )
      {
        if ( v42 && a2 == 3 )
          *(_DWORD *)(v45 + 64) = *__errno_location();
        *(_WORD *)(v45 + 114) |= 1u;
    ...
    while ( *(_QWORD *)(v45 + 24) )
    {
        ...
        || v50->d_name[1] && (v50->d_name[1] != 46 || v50->d_name[2]) )
      {
        ...
        v21 = sub_4087B1(a1, v50->d_name, v20);
        if ( !v21 )
          goto LABEL_75;
        ...
        if ( v22 >= v43 )
        {
          ...
          if ( (unsigned __int8)sub_40889A(a1, v48 + v23 + 1) != 1 )
          {
LABEL_75:
        ...
        *(_QWORD *)(v21 + 128) = v50->d_ino;
        ...
        {
          *(_WORD *)(v21 + 112) = sub_408468(a1, v21, 0LL);
...
LABEL_136:
      if ( v19 )
      {
        if ( v19 > 0x2710
          ...
          && sub_406D1B(*(_DWORD *)(a1 + 44)) )
        {
          *(_QWORD *)(a1 + 64) = sub_40793F;
          v18 = (void *)sub_40866A(a1, v18, v19);
          *(_QWORD *)(a1 + 64) = 0LL;
        }
    ...
    if ( *(_QWORD *)(v45 + 88) )
    {
      v31 = (unsigned int)sub_408AD0(a1, *(_QWORD *)(v45 + 8), 0xFFFFFFFFLL, "..") != 0;
LABEL_134:
      if ( v31 )
      {
        *(_WORD *)(v45 + 112) = 7;
...
LABEL_132:
  ...
  if ( (*(_DWORD *)(a1 + 72) & 4) != 0 || (*(_DWORD *)(a1 + 72) & 0x200) == 0 )
    ...
    v11 = *(_DWORD *)(a1 + 44);
  v12 = sub_4065AB(v11, *(_QWORD *)(v45 + 48), v10, &fd, a5, a6);
  *(_QWORD *)(v45 + 24) = v12;
  if ( *(_QWORD *)(v45 + 24) )
  {
    if ( *(_WORD *)(v45 + 112) == 11 )
    {
      v13 = sub_408468(a1, v45, 0LL);
      *(_WORD *)(v45 + 112) = v13;
    }
    else if ( (*(_DWORD *)(a1 + 72) & 0x100) != 0 )
    {
      sub_4063CC(a1, v45);
      sub_408468(a1, v45, 0LL);
      if ( (unsigned __int8)sub_4062BC(a1, v45) != 1 )
      {
        *__errno_location() = 12;
        return 0LL;
      }
