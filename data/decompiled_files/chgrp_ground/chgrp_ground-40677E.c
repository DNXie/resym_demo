...
__int64 __fastcall fts_open(const char **a1, int a2, __int64 a3)
{
  ...
  *(_DWORD *)(v5 + 44) = -100;
  ...
  if ( v22 >= 0x1000 )
    v7 = v22;
  if ( (unsigned __int8)sub_40889A(v5, v7) != 1 )
    goto LABEL_47;
  if ( *a1 )
  {
    ptr = (_QWORD *)sub_4087B1(v5, &unk_40C7AF, 0LL);
    if ( ptr )
    {
      ptr[11] = -1LL;
      goto LABEL_17;
...
LABEL_17:
  ...
  while ( *v18 )
  {
    ...
    *(_QWORD *)(v11 + 48) = v11 + 264;
    ...
    {
      *(_WORD *)(v11 + 112) = sub_408468(v5, v11, 0LL);
    }
    if ( a3 )
    {
      v12[2] = v9;
  ...
  if ( a3 && v10 > 1 )
    v9 = (void *)sub_40866A(v5, v9, v10);
  *(_QWORD *)v5 = sub_4087B1(v5, &unk_40C7AF, 0LL);
  if ( !*(_QWORD *)v5
    || (*(_QWORD *)(*(_QWORD *)v5 + 16LL) = v9,
        *(_WORD *)(*(_QWORD *)v5 + 112LL) = 9,
        (unsigned __int8)sub_406223(v5) ^ 1) )
  {
LABEL_45:
    sub_40885F(v9);
    free(ptr);
  ...
  {
    *(_DWORD *)(v5 + 40) = sub_4066D1(v5, (int)".", v13, v14, v15, v16);
    if ( *(int *)(v5 + 40) < 0 )
      *(_DWORD *)(v5 + 72) |= 4u;
  }
  sub_40AA8F(v5 + 96, 0xFFFFFFFFLL);
  return v5;
}
