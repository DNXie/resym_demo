...
__int64 __fastcall sub_40AE3F(int a1, int a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, __m128 a7, __m128 a8, __m128 a9, __m128 a10, __m128 a11, __m128 a12, __m128 a13, __m128 a14)
{
  int v14; // ecx
  int v15; // er8
  int v16; // er9
  ...
  if ( dword_60F480 < 0 )
  {
    v18 = sub_40AE3F(a1, 0, v22, a4, a5, a6);
  }
  else
  {
    ...
    {
      v18 = sub_40AE3F(a1, 0, v19, v14, v15, v16);
      if ( v18 < 0 )
