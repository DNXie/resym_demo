...
_BOOL8 __fastcall sub_401FAC(const char *a1)
{
  ...
  do
  {
    ...
    if ( *lineptr != 35 )
    {
      ...
      else
      {
        ...
        {
          v37 = (unsigned __int64)qword_60A290 >> 1;
          for ( i = 0LL;
                i < v37
             && tolower((unsigned __int8)v26[2 * i]) == byte_408430[*(_BYTE *)(v36 + i) >> 4]
             && tolower((unsigned __int8)v26[2 * i + 1]) == byte_408430[*(_BYTE *)(v36 + i) & 0xF];
                ++i )
          {
            ;
          }
  ...
  else if ( !v21 && (unsigned int)sub_40733C(stream) )
  {
  ...
  else
  {
    ...
    else
    {
      ...
      error(0, 0, v12, s1, "SHA1");
    }
    v19 = v29 && !v31 && !v32 && (byte_60A29B != 1 || !v30);
    result = v19;
  }
  return result;
}
