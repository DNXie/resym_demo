...
_BOOL8 __fastcall sub_403672(__int64 a1, unsigned int a2, __uid_t a3, __gid_t a4, int a5, int a6, __int64 a7)
{
  int v7; // eax
  char *v8; // rbx
  int *v9; // rax
  ...
  if ( a5 == -1 && a6 == -1 && !*(_BYTE *)(a7 + 16) && *(_DWORD *)a7 == 2 )
    ...
    v7 = 0;
  for ( i = sub_4093B6(a1, v7 | a2, 0LL); ; v17 = (v17 & (unsigned __int8)sub_402BFF(i, v19, a3, a4, a5, a6, a7)) != 0 )
  {
    v19 = fts_read(i);
    if ( !v19 )
      break;
