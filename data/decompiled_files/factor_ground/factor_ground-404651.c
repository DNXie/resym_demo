...
__int64 __fastcall sub_404651(const char *a1, char **a2, int a3, uintmax_t *a4, const char *a5)
{
  char **v5; // rax
  int v7; // eax
  int v8; // eax
...
LABEL_65:
      ...
      if ( v8 <= 103 )
      {
        ...
        {
          case 'b':
            v16 = sub_4045B1(&v18, 512);
            break;
          case 'c':
            v16 = 0;
            break;
          case 'Z':
            v16 = sub_404610(&v18, v14, 7);
            break;
          default:
            goto LABEL_73;
        }
      ...
      if ( v8 > 109 )
      {
        if ( v8 != 116 )
        {
          if ( v8 != 119 )
            goto LABEL_73;
          v16 = sub_4045B1(&v18, 2);
          goto LABEL_74;
        }
LABEL_69:
        v16 = sub_404610(&v18, v14, 4);
        goto LABEL_74;
      }
      if ( v8 != 107 )
        goto LABEL_73;
...
LABEL_73:
      ...
      if ( v8 != 84 )
      {
        if ( v8 != 77 )
          goto LABEL_73;
LABEL_67:
        v16 = sub_404610(&v18, v14, 2);
        goto LABEL_74;
      }
      goto LABEL_69;
    }
    v16 = sub_404610(&v18, v14, 1);
    goto LABEL_74;
  }
  v16 = sub_404610(&v18, v14, 8);
LABEL_74:
  v13 |= v16;
  *endptr += v15;
  if ( **endptr )
