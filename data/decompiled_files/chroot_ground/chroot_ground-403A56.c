...
char *__fastcall sub_403A56(_BYTE *a1, _BYTE *a2, int *a3, __gid_t *a4, char **a5, void **a6)
{
  char *v6; // rax
  ...
  *a5 = (char *)*a6;
  ...
  if ( a2 )
  {
    ...
    if ( a2 != a1 )
    {
      name = (char *)sub_40497C(a1, v22 + 1);
      name[v22] = 0;
    }
  }
  else if ( *a1 )
  {
    name = (char *)sub_4049AD(a1);
  }
  if ( a2 && a2[1] )
    v6 = a2 + 1;
  else
  ...
  if ( name )
  {
    ...
    if ( v7 )
    {
      ...
      if ( !v23 && a2 )
      {
        ...
        if ( v25 )
          ...
          v9 = sub_404FA6(gid, v26);
        ptr = (void *)sub_4049AD(v9);
        endgrent();
      }
    }
    else if ( a2 && !v23 )
    ...
    else if ( (unsigned int)sub_404AAF(name, 0LL, 10LL, &v18, &unk_405986) || v18 > 0xFFFFFFFF || (_DWORD)v18 == -1 )
    {
      msgid = off_607230;
    }
    else
  ...
  if ( v23 && !msgid )
  {
    ...
    else if ( (unsigned int)sub_404AAF(v23, 0LL, 10LL, &v18, &unk_405986) || v18 > 0xFFFFFFFF || (_DWORD)v18 == -1 )
    {
      msgid = off_607238;
    }
    else
