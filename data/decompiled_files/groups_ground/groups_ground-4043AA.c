...
__int64 __fastcall sub_4043AA(const char *a1, __gid_t a2, __gid_t **a3)
{
  __int64 result; // rax
  _BOOL8 v4; // rax
  ...
  {
    ngroups = 10;
    groups = (__gid_t *)sub_40435B(0LL, 0xAuLL);
    if ( groups )
    {
      do
      {
        ...
        if ( v7 < 0 && v8 == ngroups )
          ngroups *= 2;
        v14 = (__gid_t *)sub_40435B(groups, ngroups);
        if ( !v14 )
        {
          v9 = *__errno_location();
          free(groups);
  ...
  else
  {
    ...
    if ( ngroups >= 0 )
    {
      if ( a2 != -1 )
        ++ngroups;
      groups = (__gid_t *)sub_40435B(0LL, ngroups);
      if ( groups )
      {
        v4 = a2 != -1;
    ...
    else if ( *__errno_location() == 38 && (groups = (__gid_t *)sub_40435B(0LL, 1uLL)) != 0LL )
    {
      *a3 = groups;
      *groups = a2;
      result = a2 != -1;
