...
void *__fastcall sub_402BF6(int a1, __int64 a2, size_t a3, __int64 a4)
{
  __int64 *v4; // rax
  void *v5; // rdx
  ...
  if ( dword_606190 <= (unsigned int)a1 )
  {
    ...
    if ( off_6061B0 == &qword_6061A0 )
      ...
      v4 = off_6061B0;
    v12 = (__int64 *)sub_403BF5(v4, 16 * v14);
    off_6061B0 = v12;
    if ( v9 )
    {
      v5 = off_6061A8;
  ...
  ptr = (void *)v12[2 * a1 + 1];
  v11 = *(_DWORD *)(a4 + 4) | 1;
  v17 = sub_401D02((__int64)ptr, v15, a2, a3, *(_DWORD *)a4, v11, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  if ( v15 <= v17 )
  {
    v16 = v17 + 1;
    v12[2 * a1] = v17 + 1;
    if ( ptr != &unk_606260 )
      free(ptr);
    ptr = (void *)sub_403BA6(v16);
    v12[2 * a1 + 1] = (__int64)ptr;
    sub_401D02((__int64)ptr, v16, a2, a3, *(_DWORD *)a4, v11, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  }
