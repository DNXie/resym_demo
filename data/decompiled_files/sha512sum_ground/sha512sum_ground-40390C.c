...
unsigned __int64 __fastcall sub_40390C(char *a1, unsigned __int64 a2, size_t *a3)
{
  ...
  if ( result )
  {
    ...
    if ( a3[10] > 0x80 )
    {
      sub_403B48(a3 + 11, a3[10] & 0xFFFFFFFFFFFFFF80LL, a3);
      a3[10] &= 0x7FuLL;
  ...
  if ( v7 > 0x7F )
  {
    ...
    {
      sub_403B48(src, v7 & 0xFFFFFFFFFFFFFF80LL, a3);
