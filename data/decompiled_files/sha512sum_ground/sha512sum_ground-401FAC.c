...
_BOOL8 __fastcall sub_401FAC(const char *a1)
{
  ...
  char *v18; // rax
  bool v19; // al
  const char *s1; // [rsp+8h] [rbp-E8h]
  bool v21; // [rsp+12h] [rbp-DEh]
  int v22; // [rsp+14h] [rbp-DCh] BYREF
  char *lineptr; // [rsp+18h] [rbp-D8h] BYREF
  size_t n; // [rsp+20h] [rbp-D0h] BYREF
  char *v25; // [rsp+28h] [rbp-C8h] BYREF
  _BYTE *v26; // [rsp+30h] [rbp-C0h] BYREF
  FILE *stream; // [rsp+38h] [rbp-B8h]
  __int64 v28; // [rsp+40h] [rbp-B0h]
  __int64 v29; // [rsp+48h] [rbp-A8h]
  __int64 v30; // [rsp+50h] [rbp-A0h]
  __int64 v31; // [rsp+58h] [rbp-98h]
  __int64 v32; // [rsp+60h] [rbp-90h]
  __int64 v33; // [rsp+68h] [rbp-88h]
  signed __int64 v34; // [rsp+70h] [rbp-80h]
  unsigned __int64 i; // [rsp+78h] [rbp-78h]
  __int64 v36; // [rsp+80h] [rbp-70h]
  unsigned __int64 v37; // [rsp+88h] [rbp-68h]
  char v38[72]; // [rsp+90h] [rbp-60h] BYREF
  unsigned __int64 v39; // [rsp+D8h] [rbp-18h]
    ...
    if ( *lineptr != 35 )
    {
      ...
      else
      {
        ...
        else
        {
          ...
          for ( i = 0LL;
                i < v37
             && tolower((unsigned __int8)v26[2 * i]) == byte_40DFD0[*(_BYTE *)(v36 + i) >> 4]
             && tolower((unsigned __int8)v26[2 * i + 1]) == byte_40DFD0[*(_BYTE *)(v36 + i) & 0xF];
                ++i )
          {
            ;
          }
  ...
  else if ( !v21 && (unsigned int)sub_40CEDF(stream) )
  {
