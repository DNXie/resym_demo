...
void *__fastcall sub_40BD38(int a1, __int64 a2, size_t a3, __int64 a4)
{
  __int64 *v4; // rax
  void *v5; // rdx
  ...
  if ( dword_610200 <= (unsigned int)a1 )
  {
    ...
    if ( off_610220 == &qword_610210 )
      ...
      v4 = off_610220;
    v12 = (__int64 *)sub_40CD5D(v4, 16 * v14);
    off_610220 = v12;
    if ( v9 )
    {
      v5 = off_610218;
  ...
  ptr = (void *)v12[2 * a1 + 1];
  v11 = *(_DWORD *)(a4 + 4) | 1;
  v17 = sub_40AE44((__int64)ptr, v15, a2, a3, *(_DWORD *)a4, v11, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  if ( v15 <= v17 )
  {
    v16 = v17 + 1;
    v12[2 * a1] = v17 + 1;
    if ( ptr != &unk_610300 )
      free(ptr);
    ptr = (void *)sub_40CD0E(v16);
    v12[2 * a1 + 1] = (__int64)ptr;
    sub_40AE44((__int64)ptr, v16, a2, a3, *(_DWORD *)a4, v11, a4 + 8, *(char **)(a4 + 40), *(char **)(a4 + 48));
  }
