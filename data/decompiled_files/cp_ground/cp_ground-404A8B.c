...
__int64 __fastcall sub_404A8B(int a1, unsigned int a2, char *a3, unsigned __int64 a4, char a5, __int64 a6, __int64 a7, unsigned __int64 a8, _QWORD *a9, _BYTE *a10)
{
  size_t v10; // rax
  __int64 v11; // r12
  char *v12; // rbx
