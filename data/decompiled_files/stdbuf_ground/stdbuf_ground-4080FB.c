...
_BYTE *__fastcall sub_4080FB(_BYTE *a1, char *a2)
{
  _BYTE *result; // rax
  bool v7; // al
  bool v8; // al
    ...
    if ( *a2 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v18 && v25 > 9 && 5 * v25 <= v26 )
        {
          ...
          {
            v15 = strlen(a2);
            if ( (unsigned __int8)sub_40776A(v16, (__int64)a2, v15, &v20) )
              return (_BYTE *)v20;
            v18 = 0;
          }
        }
    ...
    if ( v35 != 1 || v36 )
    {
      ...
      for ( BYTE4(v45) = 0; ; BYTE4(v45) = 0 )
      {
        ...
        if ( v17 && v21 > 9 && 5 * v21 <= v22 )
        {
          ...
          if ( v42 == 1 && !v43 )
          {
            if ( (unsigned __int8)sub_4079B4(a1, a2, &v20) )
              return (_BYTE *)v20;
            v17 = 0;
          }
        }
