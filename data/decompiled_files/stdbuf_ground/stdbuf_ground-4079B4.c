...
__int64 __fastcall sub_4079B4(char *a1, void *a2, _QWORD *a3)
{
  void *v3; // rsp
  ...
  while ( 1 )
  {
    sub_40758A((__int64)v34);
    if ( v39 == 1 && !v40 )
      break;
    sub_4074B3(48 * v17 + v24, (__int64)&s2);
    s2 = (char *)s2 + v38;
    v36 = 0;
    ++v17;
  }
